...
<body class="container">
    <div id="loading" class="loading" style="display: none;">Loading&#8230;</div>
      ...
      <div class="well">
        <p>Mesin Kontrol Subsidi Beras Desa Merupakan Sebuah Alat untuk mengelola dan memanajemen data subsidi dan pembagian beras otomatis dan terukur menggunakan Kartu Kendali dan berbasis <i>Internet Of Things <b>IoT</b></i></p>
        <br>
      </div>
      <hr>
      <div class="row">
        <div class="col-md-5 col-sm-5 col-xs-5">
          <a class="btn btn-block btn-warning" href="/processing/laporan_beras.php">Download Laporan <i class="fa fa-table"></i></a>
        </div>
  ...
  <script src="/jquery.min.js"></script>
    ...
    <script type="text/javascript">
      ...
      function get_data() {
        $.ajax({
          url: '/processing/manager_beras.php',
          success: function(data){
            $("#loading").hide();
